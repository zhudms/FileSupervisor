...
import com.example.explorer.util.FileIconLoader.IconLoadFinishListener;
...
public class FileIconHelper implements IconLoadFinishListener {
    ...
    public static FileIconHelper instance(Context context) {
        if(mInstance == null) {
...
//        fileImageFrame.setVisibility(View.GONE);
        ...
        boolean set = false;
        int id = getFileIconId(extFromFilename);
